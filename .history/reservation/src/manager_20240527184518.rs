...
mod tests {
    ...
    async fn reserve_should_work_for_valid_window() {
        ...
        let rsvp = abi::Reservation::new_pending("xiaoyiid", "ocean-view-room-713", start, end, "I'll arrive at 3pm. Please help me to upgrade to executive room if possible."){
        };
